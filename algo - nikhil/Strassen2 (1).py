class Strassen:
    def __init__(self):
        self.mat=[]
        self.mat1=[]
        self.a11=[];self.a12=[];self.a21=[];self.a22=[];self.b11=[];self.b12=[];self.b21=[];self.b22=[]
        m=int(input("Enter number of rows"))
        n=int(input("Enter number of columns"))
        self.R=[['0' for i in range(0,n)] for j in range(0,m)]#for zero initia
        self.mat=[[int(input("Enter elements of matrix 1")) for i in range(0,n)] for j in range(0,m)]#matrix 1
        self.mat1=[[int(input("Enter elements of matrix 2")) for i in range(0,n)] for j in range(0,m)]#matrix 2
        print("Multiplication=",self.multiply(self.mat,self.mat1))
